...
const transactions = [
  { id: 1, name: "Salário - Empresa X", category: "Salário", date: "05 Nov, 2023", amount: 5000.00, type: "income", icon: "MoneyBag" },
  { id: 2, name: "Aluguel do Apartamento", category: "Moradia", date: "05 Nov, 2023", amount: -1500.00, type: "expense", icon: "Home" },
  { id: 3, name: "Supermercado da Semana", category: "Alimentação", date: "03 Nov, 2023", amount: -450.30, type: "expense", icon: "ShoppingBasket" },
  { id: 4, name: "Venda de Item Usado", category: "Renda Extra", date: "01 Nov, 2023", amount: 120.00, type: "income", icon: "Banknote" },
  { id: 5, name: "Conta de Internet", category: "Contas", date: "20 Nov, 2023", amount: -99.90, type: "expense", icon: "Wifi" },
];
                    ...
                    <td className="px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center gap-4">
                        <div className={cn("w-10 h-10 rounded-full flex items-center justify-center border",
                          ...
                          <IconByName name={tx.icon} className="w-6 h-6" />
                        </div>
